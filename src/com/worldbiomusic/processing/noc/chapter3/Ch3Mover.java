...
public class Ch3Mover {
	...
	public Ch3Mover(PApplet p) {
		this(p, new PVector((int) (Math.random() * p.width), (int) (Math.random() * p.height)), new PVector(0, 0),
				new PVector(0, 0), 10, 10, 1);
	}

	public Ch3Mover(PApplet p, float xPos, float yPos) {
		this(p);
		this.location.x = xPos;
		this.location.y = yPos;
	}

	public Ch3Mover(PApplet p, float xPos, float yPos, float mass, float r) {
		this(p, xPos, yPos);
		this.mass = mass;
		this.r = r;
	}

	public Ch3Mover(PApplet p, PVector location, PVector velocity, PVector accelation, float topspeed, float mass,
			float r) {
		this.p = p;
	...
	public boolean checkCollide(Ch3Mover other) {
...
//	float angle = PApplet.atan2(this.velocity.y, this.velocity.x);
	...
	public void attractOther(Ch3Mover other) {
	...
	public void attractedToOther(Ch3Mover other) {
		// 자신을 other에게 끌리는 메소드
	...
	public void attractedToOther(Ch3Mover other, float power) {
		// 자신을 other에게 끌리는 메소드
		PVector force = PVector.sub(other.location, this.location);
	...
	public void repulseOther(Ch3Mover other) {
		// 척력
	...
	public void repulsedFromOther(Ch3Mover other) {
		// 척력
		// 자신이 other로붙 밀리는 메소드
		PVector force = PVector.sub(other.location, this.location);
	...
	public void repulsedFromOther(Ch3Mover other, float power) {
		// 척력
		// 자신이 other로붙 밀리는 메소드
		PVector force = PVector.sub(other.location, this.location);
